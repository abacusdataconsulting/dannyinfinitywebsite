-- Add pricing to sheet music and track purchases

ALTER TABLE sheet_music ADD COLUMN price_cents INTEGER NOT NULL DEFAULT 0;

-- Purchases table — tracks completed paid sheet music purchases
...
-- Join table for bundle purchases (one purchase can include multiple sheets)
